...
% Listing for github actions
\lstdefinelanguage{yaml}{
	alsoletter=-,
  	keywords={true,false,null,y,n, name, on, jobs, push, pull_request, env, steps, runs-on, run, uses, with, working-directory, branches, paths, dotnet-version },
  	ndkeywords={},
  	sensitive=false
}
